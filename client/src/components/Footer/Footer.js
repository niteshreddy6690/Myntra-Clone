...
import g1 from "../../Assets/png/googleplay.png";
import g2 from "../../Assets/png/appleplay.png";
import g3 from "../../Assets/png/original.png";
import g4 from "../../Assets/png/return.png";
  ...
  return (
    <Fragment >
      {window.screen.width > 1024 ? (
        <Fragment>
          <div
            className="w-10/12 mx-auto grid grid-cols-12 mt-12 font1"
            style={{ maxWidth: "1600px", margin: "70px  auto 10px auto" }}
          >
          ...
          <div
            className="w-10/12 mx-auto font1 text-base text-slate-600"
            style={{ maxWidth: "1600px", margin: "0 auto" }}
          >
            <h1 className="font-semibold text-black mb-4 mt-4 text-sm">
              POPULAR SEARCHES
            </h1>
            <h1>
