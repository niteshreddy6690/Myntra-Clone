  ...
  return (
    <>
      <BannerContainer onClick={togdleArrow} isClick={isClick}>
        ...
        <p class="FreeShippingBanner-sidebar-content">FLAT ₹200 OFF</p>
      </BannerContainer>
      <BannerContentContainer isClick={isClick}>
        <div class="FreeShippingBanner-first-row">
          <div class="FreeShippingBanner-description">
            <div class="FreeShippingBanner-pre-header">Avail Flat</div>
            <div class=" FreeShippingBanner-header FreeShippingBanner-header-primary">
              ₹200 OFF
            </div>
          ...
          <div class="FreeShippingBanner-image">
            <img
              draggable="false"
              class="FreeShippingBanner-imageContent"
        ...
        <div class="FreeShippingBanner-second-row">
          <div class="FreeShippingBanner-coupon">
            <div>
              <span class="FreeShippingBanner-text">Coupon Code:</span>
              <span class="FreeShippingBanner-code">MYNTRA200</span>
            </div>
            <div class="FreeShippingBanner-footer">
              Applicable on your first order
            </div>
          </div>
          <div class="FreeShippingBanner-signup">
            <a
              class="FreeShippingBanner-button"
              href="/register?referer=https://www.myntra.com/"
            >
              <div class="FreeShippingBanner-text">SIGN UP NOW &gt;</div>
            </a>
          </div>
        </div>
        <div class="FreeShippingBanner-trust-builders">
          <div class="FreeShippingBanner-item">
            <svg
              viewBox="0 0 24 24"
              color="#03a685"
              class="FreeShippingBanner-icon"
            >
              <defs>
                <path
                  id="a"
            ...
            <span class="FreeShippingBanner-text">Genuine Products</span>
          </div>
          <div class="FreeShippingBanner-item">
            <svg
              viewBox="0 0 24 24"
              ...
              class="FreeShippingBanner-icon"
            >
              <g fill="#03a685" stroke="#03a685" stroke-width="0.6">
            ...
            <span class="FreeShippingBanner-text">Try &amp; Buy</span>
          </div>
          <div class="FreeShippingBanner-item">
            <svg
              viewBox="0 0 24 24"
            ...
            <span class="FreeShippingBanner-text">
